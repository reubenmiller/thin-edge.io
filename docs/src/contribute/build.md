...
1. Install Dependencies
    ...
    * To install Rust follow the [Official installation guide](https://www.rust-lang.org/tools/install).
...
2. Checkout the project
    ...
    :::note
    If you plan on contributing to the project, then please fork the project first, then clone your fork.
    :::
...
:::note
For macOS users, `just release` will use chose the default target based on your machines processor. The table below shows the default targets.
