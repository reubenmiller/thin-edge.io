...
tedge cert upload c8y command
    ...
    # TODO: How to support writing when prompted for input
    # Execute Command    sudo tedge cert upload c8y --user ${C8Y_CONFIG.username}
    # Write   sudo tedge cert upload c8y --user ${C8Y_CONFIG.username}
    # Write    ${C8Y_CONFIG.password}
...
Download the measurements report file
    ...
    # TODO: Assert contents of the measurement
    # Should Contain    ${measurements[1]}    ${DEVICE_SN}
    # Should Contain    ${measurements[1]}    c8y_TemperatureMeasurement.T
    # Should Contain    ${measurements[1]}    20
