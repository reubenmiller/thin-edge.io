...
mod tests {
    ...
    async fn handle_firmware_update_successful_cmd_for_main_device() {
        ...
        mqtt.send(MqttMessage::new(
            ...
            "version": "1.0",
            "remoteUrl": "http://www.my.url",
            "tedgeUrl": "http://localhost:8888/te/v1/files/test-device/firmware_update/myFirmware-c8y-mapper-1234",
        })
                .to_string(),
        ))
            .await
    ...
    async fn handle_firmware_update_successful_cmd_for_child_device() {
        ...
        mqtt.send(MqttMessage::new(
            ...
            json!({
                ...
                "version": "1.0",
                "remoteUrl": "http://www.my.url",
                "tedgeUrl": "http://localhost:8888/te/v1/files/child1/firmware_update/myFirmware-c8y-mapper-1234",
        })
                .to_string(),
        ))
            .await
