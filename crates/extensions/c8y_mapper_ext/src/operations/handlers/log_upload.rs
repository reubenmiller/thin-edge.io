    ...
    async fn mapper_converts_smartrest_logfile_req_to_log_upload_cmd_for_main_device() {
        ...
        assert_received_includes_json(
            ...
            [(
                ...
                json!({
                    "status": "init",
                    "tedgeUrl": "http://localhost:8888/te/v1/files/test-device/log_upload/logfileA-c8y-mapper-123456",
                    "type": "logfileA",
    ...
    async fn mapper_converts_smartrest_logfile_req_to_log_upload_cmd_for_child_device() {
        ...
        assert_received_includes_json(
            ...
            [(
                ...
                json!({
                    "status": "init",
                    "tedgeUrl": "http://localhost:8888/te/v1/files/test-device:device:child1/log_upload/logfileA-c8y-mapper-123456",
                    "type": "logfileA",
                    "dateFrom": "2023-11-28T16:33:50+01:00",
                    "dateTo": "2023-11-29T16:33:50+01:00",
                    "searchText": "ERROR",
